package br.com.rafaelalves.watchfacedigital;
...
import br.com.rafaelalves.commons.WatchfaceSyncCommons;

/**
 * Created by Rafael Alves Feliciano on 05/05/15.
 **/
public class SimpleWatchFaceConfigurationActivity extends ActionBarActivity implements ColourChooserDialog.Listener,
    ...
    public void onColourSelected(String colour, String tag) {
        ...
        if (TAG_BACKGROUND_COLOUR_CHOOSER.equals(tag)) {
            ...
            putDataMapRequest.getDataMap().putString(WatchfaceSyncCommons.KEY_BACKGROUND_COLOUR, colour);
        } else {
            ...
            putDataMapRequest.getDataMap().putString(WatchfaceSyncCommons.KEY_DATE_TIME_COLOUR, colour);
        }
